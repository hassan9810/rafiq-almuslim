...
export function SunnahRemindersWidget() {
  ...
  const reminders: SunnahReminder[] = useMemo(() => {
    ...
    // Friday Virtues: from Thursday Maghrib until Friday Maghrib
    const isFridayVirtuesTime =
      (dayOfWeek === 4 && nowMs >= maghribMs) ||
      (dayOfWeek === 5 && nowMs < maghribMs);
    ...
    const defaultOrderReminders: SunnahReminder[] = [
      {
        id: 'qiyam-layl',
      ...
      },
      {
        ...
        subtitle: isFridayVirtuesTime
          ? '✨ ليلة ويوم الجمعة — وقت للصلاة على النبي وقراءة سورة الكهف والدعاء'
          : '⏰ من مغرب يوم الخميس إلى مغرب يوم الجمعة',
        hadiths: [
          {
            text: 'أنَّ رَسولَ اللهِ صلَّى اللهُ عليه وسلَّم ذَكَرَ يَومَ الجُمُعةِ، فقال: فيه ساعةٌ لا يوافِقُها عَبدٌ مُسلِمٌ وهو قائِمٌ يُصَلِّي، يَسألُ اللهَ تَعالى شيئًا، إلَّا أعطاه إيَّاه، وأشارَ بيَدِه يُقَلِّلُها.',
            source: 'الراوي: أبو هريرة | المحدث: البخاري | صحيح البخاري ٩٣٥\nالتخريج: أخرجه مسلم (٨٥٢) باختلاف يسير',
            grade: 'صحيح',
          },
          {
            ...
            source: 'الراوي: أبو هريرة | المحدث: مسلم | صحيح مسلم ٨٥٤',
            grade: 'صحيح',
          },
          {
            text: 'إن من أفضلِ أيامِكم يومَ الجمعةِ فأكثروا علَيَّ من الصلاةِ فيه فإن صلاتَكم معروضةٌ عليَّ . قالوا: يا رسولَ اللهِ كيف تُعرضُ صلاتُنا عليك وقد أرِمتَ؟ قال: إنَّ اللهَ حرم على الأرضِ أن تأكلَ أجسادَ الأنبياءِ',
            source: 'الراوي: أوس بن أبي أوس | المحدث: ابن باز | مجموع فتاوى ابن باز ٣٩٤/٢\nالتخريج: أخرجه النسائي (١٣٧٤)، وابن ماجه (١٦٣٦)، وأحمد (١٦١٦٢)',
            grade: 'حسن',
          },
          {
            text: 'قلتُ: يا رسولَ اللهِ، إنِّي أُكثِرُ الصَّلاةَ عليك، فكم أجعلُ لك من صلاتي؟ فقال: ما شئتَ، قلت: الرُّبعَ؟ قال: ما شئتَ، فإن زِدتَ فهو خيرٌ لك، قلتُ: النِّصفَ؟ قال: ما شئتَ، فإن زدتَ فهو خيرٌ لك، قلت : فالثُّلُثَيْنِ؟ قال: ما شئتَ، فإن زدتَ فهو خيرٌ لك، قلتُ : أجعلُ لك صلاتي كلَّها؟ قال: إذًا تُكْفَى همَّك، ويُكَفَّرُ لك ذنبُك',
            source: 'الراوي: أبي بن كعب | المحدث: الألباني | هداية الرواة ٨٨٩\nالتخريج: أخرجه الترمذي (٢٤٥٧)، وأحمد (٢١٢٤٢)',
            grade: 'حسن',
          },
          {
            text: 'من قرأ سورةَ ( الكهفِ ) في يومِ الجمعةِ أضاء له من النورِ ما بين الجمُعَتَين',
            source: 'الراوي: أبو سعيد الخدري | المحدث: الألباني | صحيح الترغيب ٧٣٦',
            grade: 'صحيح',
          },
          {
            text: 'من غسَّل يومَ الجمعةِ واغتسل وبكَّرَ وابتكرَ ومشى ولم يَركبْ ودنا من الإمامِ واستمع ولم يَلْغُ كان له بكلِّ خطوةٍ عملُ سنةٍ أجرُ صيامِها وقيامِها',
            source: 'الراوي: أوس بن أبي أوس | المحدث: ابن حجر العسقلاني | هداية الرواة ٢/١٠٣\nالتخريج: أخرجه ابن ماجه (١٠٨٧)، وأبو داود (٣٤٥)، والترمذي (٤٩٦)',
            grade: 'حسن',
          },
        ],
        timeInfo: 'من مغرب يوم الخميس إلى مغرب يوم الجمعة',
        isActive: isFridayVirtuesTime,
    ...
    return [...defaultOrderReminders].sort((a, b) => Number(b.isActive) - Number(a.isActive));
