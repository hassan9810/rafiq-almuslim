...
export const surahNames: { number: number; name: string; nameAr: string; ayahs: number; type: 'Meccan' | 'Medinan' }[] = [
  { number: 1, name: 'Al-Fatiha', nameAr: 'الفاتحة', ayahs: 7, type: 'Meccan' },
  { number: 2, name: 'Al-Baqarah', nameAr: 'البقرة', ayahs: 286, type: 'Medinan' },
  { number: 3, name: 'Aal-Imran', nameAr: 'آل عمران', ayahs: 200, type: 'Medinan' },
  { number: 4, name: 'An-Nisa', nameAr: 'النساء', ayahs: 176, type: 'Medinan' },
  { number: 5, name: 'Al-Maidah', nameAr: 'المائدة', ayahs: 120, type: 'Medinan' },
  { number: 6, name: 'Al-Anam', nameAr: 'الأنعام', ayahs: 165, type: 'Meccan' },
  { number: 7, name: 'Al-Araf', nameAr: 'الأعراف', ayahs: 206, type: 'Meccan' },
  { number: 8, name: 'Al-Anfal', nameAr: 'الأنفال', ayahs: 75, type: 'Medinan' },
  { number: 9, name: 'At-Tawbah', nameAr: 'التوبة', ayahs: 129, type: 'Medinan' },
  { number: 10, name: 'Yunus', nameAr: 'يونس', ayahs: 109, type: 'Meccan' },
  { number: 11, name: 'Hud', nameAr: 'هود', ayahs: 123, type: 'Meccan' },
  { number: 12, name: 'Yusuf', nameAr: 'يوسف', ayahs: 111, type: 'Meccan' },
  { number: 13, name: 'Ar-Rad', nameAr: 'الرعد', ayahs: 43, type: 'Medinan' },
  { number: 14, name: 'Ibrahim', nameAr: 'إبراهيم', ayahs: 52, type: 'Meccan' },
  { number: 15, name: 'Al-Hijr', nameAr: 'الحجر', ayahs: 99, type: 'Meccan' },
  { number: 16, name: 'An-Nahl', nameAr: 'النحل', ayahs: 128, type: 'Meccan' },
  { number: 17, name: 'Al-Isra', nameAr: 'الإسراء', ayahs: 111, type: 'Meccan' },
  { number: 18, name: 'Al-Kahf', nameAr: 'الكهف', ayahs: 110, type: 'Meccan' },
  { number: 19, name: 'Maryam', nameAr: 'مريم', ayahs: 98, type: 'Meccan' },
  { number: 20, name: 'Ta-Ha', nameAr: 'طه', ayahs: 135, type: 'Meccan' },
  { number: 21, name: 'Al-Anbiya', nameAr: 'الأنبياء', ayahs: 112, type: 'Meccan' },
  { number: 22, name: 'Al-Hajj', nameAr: 'الحج', ayahs: 78, type: 'Medinan' },
  { number: 23, name: 'Al-Muminun', nameAr: 'المؤمنون', ayahs: 118, type: 'Meccan' },
  { number: 24, name: 'An-Nur', nameAr: 'النور', ayahs: 64, type: 'Medinan' },
  { number: 25, name: 'Al-Furqan', nameAr: 'الفرقان', ayahs: 77, type: 'Meccan' },
  { number: 26, name: 'Ash-Shuara', nameAr: 'الشعراء', ayahs: 227, type: 'Meccan' },
  { number: 27, name: 'An-Naml', nameAr: 'النمل', ayahs: 93, type: 'Meccan' },
  { number: 28, name: 'Al-Qasas', nameAr: 'القصص', ayahs: 88, type: 'Meccan' },
  { number: 29, name: 'Al-Ankabut', nameAr: 'العنكبوت', ayahs: 69, type: 'Meccan' },
  { number: 30, name: 'Ar-Rum', nameAr: 'الروم', ayahs: 60, type: 'Meccan' },
  { number: 31, name: 'Luqman', nameAr: 'لقمان', ayahs: 34, type: 'Meccan' },
  { number: 32, name: 'As-Sajdah', nameAr: 'السجدة', ayahs: 30, type: 'Meccan' },
  { number: 33, name: 'Al-Ahzab', nameAr: 'الأحزاب', ayahs: 73, type: 'Medinan' },
  { number: 34, name: 'Saba', nameAr: 'سبأ', ayahs: 54, type: 'Meccan' },
  { number: 35, name: 'Fatir', nameAr: 'فاطر', ayahs: 45, type: 'Meccan' },
  { number: 36, name: 'Ya-Sin', nameAr: 'يس', ayahs: 83, type: 'Meccan' },
  { number: 37, name: 'As-Saffat', nameAr: 'الصافات', ayahs: 182, type: 'Meccan' },
  { number: 38, name: 'Sad', nameAr: 'ص', ayahs: 88, type: 'Meccan' },
  { number: 39, name: 'Az-Zumar', nameAr: 'الزمر', ayahs: 75, type: 'Meccan' },
  { number: 40, name: 'Ghafir', nameAr: 'غافر', ayahs: 85, type: 'Meccan' },
  { number: 41, name: 'Fussilat', nameAr: 'فصلت', ayahs: 54, type: 'Meccan' },
  { number: 42, name: 'Ash-Shura', nameAr: 'الشورى', ayahs: 53, type: 'Meccan' },
  { number: 43, name: 'Az-Zukhruf', nameAr: 'الزخرف', ayahs: 89, type: 'Meccan' },
  { number: 44, name: 'Ad-Dukhan', nameAr: 'الدخان', ayahs: 59, type: 'Meccan' },
  { number: 45, name: 'Al-Jathiyah', nameAr: 'الجاثية', ayahs: 37, type: 'Meccan' },
  { number: 46, name: 'Al-Ahqaf', nameAr: 'الأحقاف', ayahs: 35, type: 'Meccan' },
  { number: 47, name: 'Muhammad', nameAr: 'محمد', ayahs: 38, type: 'Medinan' },
  { number: 48, name: 'Al-Fath', nameAr: 'الفتح', ayahs: 29, type: 'Medinan' },
  { number: 49, name: 'Al-Hujurat', nameAr: 'الحجرات', ayahs: 18, type: 'Medinan' },
  { number: 50, name: 'Qaf', nameAr: 'ق', ayahs: 45, type: 'Meccan' },
  { number: 51, name: 'Adh-Dhariyat', nameAr: 'الذاريات', ayahs: 60, type: 'Meccan' },
  { number: 52, name: 'At-Tur', nameAr: 'الطور', ayahs: 49, type: 'Meccan' },
  { number: 53, name: 'An-Najm', nameAr: 'النجم', ayahs: 62, type: 'Meccan' },
  { number: 54, name: 'Al-Qamar', nameAr: 'القمر', ayahs: 55, type: 'Meccan' },
  { number: 55, name: 'Ar-Rahman', nameAr: 'الرحمن', ayahs: 78, type: 'Medinan' },
  { number: 56, name: 'Al-Waqiah', nameAr: 'الواقعة', ayahs: 96, type: 'Meccan' },
  { number: 57, name: 'Al-Hadid', nameAr: 'الحديد', ayahs: 29, type: 'Medinan' },
  { number: 58, name: 'Al-Mujadila', nameAr: 'المجادلة', ayahs: 22, type: 'Medinan' },
  { number: 59, name: 'Al-Hashr', nameAr: 'الحشر', ayahs: 24, type: 'Medinan' },
  { number: 60, name: 'Al-Mumtahanah', nameAr: 'الممتحنة', ayahs: 13, type: 'Medinan' },
  { number: 61, name: 'As-Saff', nameAr: 'الصف', ayahs: 14, type: 'Medinan' },
  { number: 62, name: 'Al-Jumuah', nameAr: 'الجمعة', ayahs: 11, type: 'Medinan' },
  { number: 63, name: 'Al-Munafiqun', nameAr: 'المنافقون', ayahs: 11, type: 'Medinan' },
  { number: 64, name: 'At-Taghabun', nameAr: 'التغابن', ayahs: 18, type: 'Medinan' },
  { number: 65, name: 'At-Talaq', nameAr: 'الطلاق', ayahs: 12, type: 'Medinan' },
  { number: 66, name: 'At-Tahrim', nameAr: 'التحريم', ayahs: 12, type: 'Medinan' },
  { number: 67, name: 'Al-Mulk', nameAr: 'الملك', ayahs: 30, type: 'Meccan' },
  { number: 68, name: 'Al-Qalam', nameAr: 'القلم', ayahs: 52, type: 'Meccan' },
  { number: 69, name: 'Al-Haqqah', nameAr: 'الحاقة', ayahs: 52, type: 'Meccan' },
  { number: 70, name: 'Al-Maarij', nameAr: 'المعارج', ayahs: 44, type: 'Meccan' },
  { number: 71, name: 'Nuh', nameAr: 'نوح', ayahs: 28, type: 'Meccan' },
  { number: 72, name: 'Al-Jinn', nameAr: 'الجن', ayahs: 28, type: 'Meccan' },
  { number: 73, name: 'Al-Muzzammil', nameAr: 'المزمل', ayahs: 20, type: 'Meccan' },
  { number: 74, name: 'Al-Muddaththir', nameAr: 'المدثر', ayahs: 56, type: 'Meccan' },
  { number: 75, name: 'Al-Qiyamah', nameAr: 'القيامة', ayahs: 40, type: 'Meccan' },
  { number: 76, name: 'Al-Insan', nameAr: 'الإنسان', ayahs: 31, type: 'Medinan' },
  { number: 77, name: 'Al-Mursalat', nameAr: 'المرسلات', ayahs: 50, type: 'Meccan' },
  { number: 78, name: 'An-Naba', nameAr: 'النبأ', ayahs: 40, type: 'Meccan' },
  { number: 79, name: 'An-Naziat', nameAr: 'النازعات', ayahs: 46, type: 'Meccan' },
  { number: 80, name: 'Abasa', nameAr: 'عبس', ayahs: 42, type: 'Meccan' },
  { number: 81, name: 'At-Takwir', nameAr: 'التكوير', ayahs: 29, type: 'Meccan' },
  { number: 82, name: 'Al-Infitar', nameAr: 'الانفطار', ayahs: 19, type: 'Meccan' },
  { number: 83, name: 'Al-Mutaffifin', nameAr: 'المطففين', ayahs: 36, type: 'Meccan' },
  { number: 84, name: 'Al-Inshiqaq', nameAr: 'الانشقاق', ayahs: 25, type: 'Meccan' },
  { number: 85, name: 'Al-Buruj', nameAr: 'البروج', ayahs: 22, type: 'Meccan' },
  { number: 86, name: 'At-Tariq', nameAr: 'الطارق', ayahs: 17, type: 'Meccan' },
  { number: 87, name: 'Al-Ala', nameAr: 'الأعلى', ayahs: 19, type: 'Meccan' },
  { number: 88, name: 'Al-Ghashiyah', nameAr: 'الغاشية', ayahs: 26, type: 'Meccan' },
  { number: 89, name: 'Al-Fajr', nameAr: 'الفجر', ayahs: 30, type: 'Meccan' },
  { number: 90, name: 'Al-Balad', nameAr: 'البلد', ayahs: 20, type: 'Meccan' },
  { number: 91, name: 'Ash-Shams', nameAr: 'الشمس', ayahs: 15, type: 'Meccan' },
  { number: 92, name: 'Al-Layl', nameAr: 'الليل', ayahs: 21, type: 'Meccan' },
  { number: 93, name: 'Ad-Duhaa', nameAr: 'الضحى', ayahs: 11, type: 'Meccan' },
  { number: 94, name: 'Ash-Sharh', nameAr: 'الشرح', ayahs: 8, type: 'Meccan' },
  { number: 95, name: 'At-Tin', nameAr: 'التين', ayahs: 8, type: 'Meccan' },
  { number: 96, name: 'Al-Alaq', nameAr: 'العلق', ayahs: 19, type: 'Meccan' },
  { number: 97, name: 'Al-Qadr', nameAr: 'القدر', ayahs: 5, type: 'Meccan' },
  { number: 98, name: 'Al-Bayyinah', nameAr: 'البينة', ayahs: 8, type: 'Medinan' },
  { number: 99, name: 'Az-Zalzalah', nameAr: 'الزلزلة', ayahs: 8, type: 'Medinan' },
  { number: 100, name: 'Al-Adiyat', nameAr: 'العاديات', ayahs: 11, type: 'Meccan' },
  { number: 101, name: 'Al-Qariah', nameAr: 'القارعة', ayahs: 11, type: 'Meccan' },
  { number: 102, name: 'At-Takathur', nameAr: 'التكاثر', ayahs: 8, type: 'Meccan' },
  { number: 103, name: 'Al-Asr', nameAr: 'العصر', ayahs: 3, type: 'Meccan' },
  { number: 104, name: 'Al-Humazah', nameAr: 'الهمزة', ayahs: 9, type: 'Meccan' },
  { number: 105, name: 'Al-Fil', nameAr: 'الفيل', ayahs: 5, type: 'Meccan' },
  { number: 106, name: 'Quraysh', nameAr: 'قريش', ayahs: 4, type: 'Meccan' },
  { number: 107, name: 'Al-Maun', nameAr: 'الماعون', ayahs: 7, type: 'Meccan' },
  { number: 108, name: 'Al-Kawthar', nameAr: 'الكوثر', ayahs: 3, type: 'Meccan' },
  { number: 109, name: 'Al-Kafirun', nameAr: 'الكافرون', ayahs: 6, type: 'Meccan' },
  { number: 110, name: 'An-Nasr', nameAr: 'النصر', ayahs: 3, type: 'Medinan' },
  { number: 111, name: 'Al-Masad', nameAr: 'المسد', ayahs: 5, type: 'Meccan' },
  { number: 112, name: 'Al-Ikhlas', nameAr: 'الإخلاص', ayahs: 4, type: 'Meccan' },
  { number: 113, name: 'Al-Falaq', nameAr: 'الفلق', ayahs: 5, type: 'Meccan' },
  { number: 114, name: 'An-Nas', nameAr: 'الناس', ayahs: 6, type: 'Meccan' }
];
...
export async function fetchPageAyahs(pageNumber: number): Promise<PageAyahs | null> {
  try {
    const response = await fetch(`${QURAN_API}/page/${pageNumber}/quran-simple`);
    const data = await response.json();
...
export async function fetchPageWithTranslation(
  ...
  try {
    const [arabicRes, translationRes] = await Promise.all([
      fetch(`${QURAN_API}/page/${pageNumber}/quran-simple`),
